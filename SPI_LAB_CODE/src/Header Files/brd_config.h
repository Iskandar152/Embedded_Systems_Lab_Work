...
//Hardware Dependences for Si1133
...
#define SI1133_GPIOMODE         gpioModePushPull
#define SI1133_ENABLE_DEFAULT   false

#define SI1133_SCL_DEFAULT      true
#define SI1133_SDA_DEFAULT      true

//Hardware Dependencies for UART
#define UART_TX_PORT           gpioPortF
#define UART_TX_PIN            3
#define UART_RX_PORT           gpioPortF
#define UART_RX_PIN            4

#define UART_TX_DRIVE_STRENGTH gpioDriveStrengthStrongAlternateWeak

#define UART_TX_DEFAULT        true
#define UART_RX_DEFAULT        true

//Defines for ble_open
...
//SPI
#define ICM20648_SENSOR_EN_PORT    gpioPortF
#define ICM20648_SENSOR_EN_PIN     8
#define ICM20648_INT_PORT   gpioPortF
#define ICM20648_INT_PIN    12
#define ICM20648_CS_PORT    gpioPortC
#define ICM20648_CS_PIN     3
#define ICM20648_SCLK_PORT  gpioPortC
#define ICM20648_SCLK_PIN   2
#define ICM20648_MOSI_PORT  gpioPortC
#define ICM20648_MOSI_PIN   0
#define ICM20648_MISO_PORT  gpioPortC
#define ICM20648_MISO_PIN   1

#define SPI_TX_ROUTE          USART_ROUTELOC0_TXLOC_LOC18
#define SPI_RX_ROUTE          USART_ROUTELOC0_RXLOC_LOC18
#define SPI_CS_ROUTE          USART_ROUTELOC0_CSLOC_LOC18
#define SPI_CLK_ROUTE         USART_ROUTELOC0_CLKLOC_LOC18

#define SPI_TX_DRIVE_STRENGTH gpioDriveStrengthWeakAlternateStrong
#define SPI_RX_DRIVE_STRENGTH gpioDriveStrengthWeakAlternateStrong
//********************************************************************************
// function prototypes
//***********************************************************************************
